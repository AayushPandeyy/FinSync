...
//                               Text(
//                                 '$_currencySymbol ${totalGiven.toStringAsFixed(0)}',
...
//                               const SizedBox(height: 8),
//                               Text(
//                                 '$_currencySymbol ${totalTaken.toStringAsFixed(0)}',
//                                 style: const TextStyle(
//                                   fontSize: 20,
//                                   fontWeight: FontWeight.w700,
//                                   color: Color(0xFF1A1A1A),
...
//                 child: Column(
//                   children: [
//                     _buildDetailRow('Total Amount', '$_currencySymbol ${loan.totalAmount}', Icons.account_balance_wallet, width),
//                     SizedBox(height: width * 0.04),
//                     _buildDetailRow('Paid Amount', '$_currencySymbol ${loan.paidAmount}', Icons.check_circle_outline, width),
//                     SizedBox(height: width * 0.04),
//                     _buildDetailRow('Remaining', '$_currencySymbol ${loan.remainingAmount}', Icons.pending_outlined, width, 
...
//                   children: [
//                     Text(
//                       '$_currencySymbol ${loan.remainingAmount.toStringAsFixed(0)}',
