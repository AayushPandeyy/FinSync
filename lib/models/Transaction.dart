class TransactionModel {
  ...
  // The wallet associated with this transaction (e.g., "Cash", "Bank", "Digital Wallet")
  final String wallet;
  ...
  factory TransactionModel.fromJson(Map<String, dynamic> json) {
    return TransactionModel(
      ...
      transactionDescription: json[
          "transactionDescription"], // A transactionDescription of the transaction
      date: DateTime.parse(
          json['date']), // The date of the transaction (converted to DateTime)
      category: json['category'], // The category of the transaction
      type: json["type"], // The transaction type (Income/Expense)
      wallet: json['wallet'] ?? 'Cash', // The wallet used for this transaction
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'wallet': wallet, // The wallet associated with this transaction
    };
  }
  ...
  static List<Map<String, dynamic>> listToJson(
    ...
    return TransactionModels.map(
        (TransactionModel) => TransactionModel.toJson()).toList();
  }
